  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        className="fixed bottom-5 right-5 z-[70] flex h-14 w-14 items-center justify-center rounded-full bg-brand-green text-black shadow-[0_8px_32px_rgba(34,242,58,0.45)] transition-all duration-300 hover:scale-105 active:scale-95"
      >
        {open ? (
