    ...
    <section className="relative bg-gray-950 py-20 lg:py-32 border-t border-gray-800">
      <div className="max-w-[1280px] mx-auto px-4 md:px-8">
        ...
        <div className="mt-14 lg:mt-20 relative grid grid-cols-1 md:grid-cols-2 gap-px bg-gray-800 border border-gray-800 rounded-2xl overflow-hidden">
          ...
          <div className="relative bg-gray-950 p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-6">
              <BrandMark size={20} />
              <h3 className="font-display font-semibold text-xl text-gray-100">{t("nosotros")}</h3>
            </div>
            <ul className="space-y-4">
          ...
          <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center justify-center z-10 bg-gray-950 p-1.5 rounded-full">
